...
import com.hik.trendycraftshow.QuickChat.UI.adapters.ChatAdapter;
import com.hik.trendycraftshow.QuickChat.core.Chat;
import com.hik.trendycraftshow.QuickChat.core.ChatService;
import com.hik.trendycraftshow.QuickChat.core.GroupChatImpl;
import com.hik.trendycraftshow.QuickChat.core.PrivateChatImpl;
...
public class ChatActivity extends BaseActivity  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_chat, container);
    ...
    private void initViews() {
        ...
        if (dialog.getType() == QBDialogType.GROUP) {
            ...
            Chatcontainer.removeView(meLabel);
            Chatcontainer.removeView(companionLabel);
...
//                setStickersFrameVisible(false);
  ...
  /*  @Override
    ...
    public void setContentBottomPadding(int padding) {
        Chatcontainer.setPadding(0, 0, 0, padding);
    }
